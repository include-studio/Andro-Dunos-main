...
bool ModuleStage1::Start()
{
	...
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2300, 60); //WAVINGSHIP
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2315, 60);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2326, 60);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2338, 60);

	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2435, 140);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2445, 140);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2456, 140);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2468, 140);


	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2550, 60, true);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2565, 60);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2576, 60);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2588, 60);

	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2705, 140);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2715, 140);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2726, 140);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 2738, 140);

	//App->enemies->AddEnemy(ENEMY_TYPES::POWERUP, 1838, 90); // ENEMY_POWERUP
	//App->enemies->AddEnemy(ENEMY_TYPES::POWERUP, 21738, 90);
	//App->enemies->AddEnemy(ENEMY_TYPES::POWERUP, 32558, 90);

	//App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 2935, 40); //HORIZONTALROCKET
	//App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 2915, 60);
	//App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 2936, 80);

	//App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 3035, 100);
	//App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 3015, 120);
	//App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 3036, 140);

	//App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 3135, 40);
	//App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 3115, 60);
	//App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 3136, 80);

	//App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 3285, 45);
	//App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 3265, 65);
	//App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 3245, 85);
	//App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 3230, 90);
	//App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 3265, 105);
	//App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 3285, 125);

	

	

	App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 3703, SCREEN_HEIGHT / 2 + 224); //MINI-MINIBOSS
	App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 3753, (SCREEN_HEIGHT / 2) + 40 + 124, true);
	App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 3753, (SCREEN_HEIGHT / 2) - 40 + 124);
	App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 3803, (SCREEN_HEIGHT / 2) + 40 + 124);
	App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 3803, (SCREEN_HEIGHT / 2) - 40 + 124);

	

	App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 5935, 40); //HORIZONTALROCKET
	App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 5915, 60);
	App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 5936, 80);

	App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 6035, 100);
	App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 6015, 120);
	App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 6036, 140);

	App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 6135, 40);
	App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 6115, 60);
	App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 6136, 80);

	App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 6285, 45);
	App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 6265, 65);
	App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 6245, 85);
	App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 6230, 90);
	App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 6265, 105);
	App->enemies->AddEnemy(ENEMY_TYPES::HORIZONTALROCKET, 6285, 125);



	App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 6703, SCREEN_HEIGHT / 2 + 224); //MINI-MINIBOSS
	App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 6753, (SCREEN_HEIGHT / 2) + 40 + 224, true);
	App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 6753, (SCREEN_HEIGHT / 2) - 40 + 224);
	App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 6803, (SCREEN_HEIGHT / 2) + 40 + 224);
	App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 6803, (SCREEN_HEIGHT / 2) - 40 + 224);
	...
	App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 7565, 60 );
	App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 7576, 60 );
	App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 7588, 60 );

	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 7705, 140 );
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 7715, 140 );
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 7726, 140 );
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 7738, 140 );

	//App->enemies->AddEnemy(ENEMY_TYPES::POWERUP, 7838, 90); // ENEMY_POWERUP
	//App->enemies->AddEnemy(ENEMY_TYPES::POWERUP, 81738, 90);
	//App->enemies->AddEnemy(ENEMY_TYPES::POWERUP, 92558, 90);
	...
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 8550, 60, true);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 8565, 60);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 8576, 60);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 8588, 60);

	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 8705, 140);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 8715, 140);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 8726, 140);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 8738, 140);

	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 9435, 140);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 9445, 140);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 9456, 140);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 9468, 140);


	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 9550, 60, true);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 9565, 60);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 9576, 60);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 9588, 60);

	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 9705, 140);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 9715, 140);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 9726, 140);
	//App->enemies->AddEnemy(ENEMY_TYPES::WAVINGSHIP, 9738, 140);

	//App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 10000, SCREEN_HEIGHT / 2 + 224); //MINI-MINIBOSS
	//App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 10100, (SCREEN_HEIGHT / 2) + 40 + 124, true);
	//App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 10100, (SCREEN_HEIGHT / 2) - 40 + 124);
	//App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 10200, (SCREEN_HEIGHT / 2) + 40 + 124);
	//App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 10200, (SCREEN_HEIGHT / 2) - 40 + 124);

	//App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 10400, SCREEN_HEIGHT / 2 + 224); //MINI-MINIBOSS
	//App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 10500, (SCREEN_HEIGHT / 2) + 40 + 124, true);
	//App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 10500, (SCREEN_HEIGHT / 2) - 40 + 124);
	//App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 10600, (SCREEN_HEIGHT / 2) + 40 + 124);
	//App->enemies->AddEnemy(ENEMY_TYPES::MINIMINIBOSS, 10600, (SCREEN_HEIGHT / 2) - 40 + 124);
