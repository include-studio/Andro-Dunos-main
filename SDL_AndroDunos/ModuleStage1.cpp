...
bool ModuleStage1::Start()
{
	...
	//1UP
	App->powerup->AddPowerUp(App->powerup->one_up, 400, 120, COLLIDER_ONE_UP);    //Just a test
	...
	App->enemies->AddEnemy(ENEMY_TYPES::MINIGREEN1, 415, 33);
	App->enemies->AddEnemy(ENEMY_TYPES::MINIGREEN2, 415, 119);
