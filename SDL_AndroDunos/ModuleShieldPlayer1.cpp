...
update_status ModuleShieldPlayer1::Update() {
	...
	case 1:
		position1.x=App->player1->position.x + int(27.0f * cosf(rotation))+6;
		position1.y = App->player1->position.y + int(27.0f * sinf(rotation));
		position2.x = App->player1->position.x + int(27.0f * cosf(rotation+PI))+6;
		...
		break;
	case 2:
		position1.x = App->player1->position.x + 6;
		position1.y = App->player1->position.y - 15;
		position2.x = App->player1->position.x + 6;
	...
	case 3:
		...
		position1.x = App->player1->position.x + 26;
		position1.y = App->player1->position.y - 8;
		position2.x = App->player1->position.x + 26;
	...
	case 4:
		...
		position1.x = App->player1->position.x -12;
		position1.y = App->player1->position.y - 8;
		position2.x = App->player1->position.x -12;
		position2.y = App->player1->position.y + 14;
